...
<body>
  ...
  <section class="class-info-form">
    <h2>CLASS INFO</h2>
    <form method="POST" action="registerLectClass.php">
	 <label for="CLASS_CODE">Class Code</label>
      ...
      <input type="text" name="SUBJECT_NAME" placeholder="e.g. INTRODUCTION TO WEB AND MOBILE APPLICATION" required>
	  <label for="LECT_ID">Lecturer Teaching</label>
      <input type="text" name="LECT_ID" placeholder="e.g. A2023XXXXXX" required>
      <label for="STUDENT_ID">Add Student</label>
      <input type="text" name="STUDENT_ID" placeholder="e.g. 2023XXXXXX" required>
